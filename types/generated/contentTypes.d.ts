...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bulletPoints: Schema.Attribute.Component<'about.icon-text', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiExperienceExperience extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heading: Schema.Attribute.String;
    items: Schema.Attribute.Component<'experience.experience-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiManifestManifest extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    projectVersion: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    projects: Schema.Attribute.Component<'project.project-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSkillSkill extends Struct.SingleTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Component<'skills.skills-category', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
